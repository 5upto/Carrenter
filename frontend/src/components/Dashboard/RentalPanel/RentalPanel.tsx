...
const RentalPanel = (props: Props) => {
  ...
  const validationSchema = Yup.object({
    carId: Yup.number().required(`${t("data")}`),
    endDate: Yup.string().required(`${t("data")}`),
    endKilometer: Yup.number().nullable(),
    returnDate: Yup.string().nullable(),
    startKilometer: Yup.number().required(`${t("data")}`),
    startDate: Yup.string().required(`${t("data")}`),
    totalPrice: Yup.number().required(`${t("data")}`),
    userId: Yup.number().required(`${t("data")}`),
  });
